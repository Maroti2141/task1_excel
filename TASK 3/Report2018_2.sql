...
Create table Product_Details(
	...
	Customer_primary_id1 int,
	FOREIGN KEY (Customer_primary_id1) REFERENCES Report2018(id)
	
)

select*from Product_Details

insert into Product_Details (product_id,product_name,category,sub_category,customer_primary_id1)
...
create table Sales_data(
	...
	customer_primary_id2 int,
	FOREIGN KEY (customer_primary_id2) REFERENCES Report2018(id)
)

select*from Sales_data

insert into Sales_data(Sales,Quantity,Discount,Profit,Shiping_cost,Order_priority,customer_primary_id2)
